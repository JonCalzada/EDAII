...
/**
* Implementa un SortedMap como un árbol B +. */
///////////////////////////////////////////////////////////////////////////////
public class BPTree<K, V> extends AbstractMap<K,V> implements SortedMap<K,V>
{
	...
	/**
	 * Crea un nuevo BPTree de orden y de hoja 3 y asume que todas las claves implementan Comparable.
	 */
	BPTree()
	{
	 ...
	 * 
95/5000
Crea un nuevo BPTree de orden y hoja de pedido 3.
* @param c Comparator para usar para ordenar objetos.
	 */
	BPTree(Comparator c)
	{
		this(c, 3, 3);
	...
	/**
	 * Crea un nuevo BPTree y asume que todas las claves implementan Comparable.
	...
	/**
	 * Devuelve la primera clave actualmente en este BPTree.
	 */
	public K firstKey()
	{
		if(size == 0)
	...
	/**
	 * Devuelve la última clave actualmente en este BPTree.
	 */
	public K lastKey()
	{
		if(size == 0)
	...
	/**
	 * Devuelve el comparador asociado con este BPTree, o nulo si utiliza el orden natural de sus claves.
	 */
	...
	/**
	 * 56/5000
Devuelve el número de asignaciones clave-valor en este BPTree.
	 */
	public int size()
	{
		return size;
	...
	/**
	 * Devuelve verdadero si este BPTree contiene una asignación para la clave especificada.
	 */
	...
	/**
	 * Devuelve el valor al que este BPTree asigna la clave especificada o nula si no contiene ninguna asignación para la clave.
	 */
	...
	/**
	 * Elimina la clave especificada de este mapa
	 */
	...
	/**
	 *67/5000
Devuelve el índice a seguir en un nodo guía para la clave especificada.
	 */
	...
	/**
	 * Imprime este BPTree en el StringWriter especificado en formato XML.
	 */
...
////////////////////////////////////////////////////////////////////////////////////
	...
	/**
	 * 36/5000
Representa un nodo guía en el árbol.
	 */
////////////////////////////////////////////////////////////////////////////////////
	private class GuideNode extends Node
	{
		...
		/**
		 * Elimina la clave especificada de este nodo.
* 		@return 0 si no se eliminó nada, 1 si se eliminó una clave pero los nodos no se fusionaron,
*		 2 si este Nodo se fusionó con su hermano izquierdo, o 3 si este Nodo se fusionó con su hermano derecho.
		 */
	...
	/**
	 * Representa un nodo hoja en el árbol.
	 */
...
////////////////////////////////////////////////////////////////////////////////////
	private class LeafNode extends Node
	{
		 ...
		 *
75/5000
Imprime este nodo y todas las claves en el StringWriter especificado en formato XML.
		 */
		public void printXml(StringWriter out, int indent)
		{
			for(int i = 0; i < indent; i++)
	...
	/**
	 *Lanza objetos a Comparable y los compara.
	 */
////////////////////////////////////////////////////////////////////////////////////
	...
	/**
	 *Un SortedMap que representa una subregión del espacio de claves mapeado por un BPTree.
	 */
////////////////////////////////////////////////////////////////////////////////////
	private class SubMap extends AbstractMap<K,V> implements SortedMap<K,V>
	{
		...
		/**
		 * Crea un nuevo SubMap que representa la subregión entre bajo (inclusivo) y alto (exclusivo).
		 */
		...
		/**
		 *Crea un nuevo SubMap que representa todo el BPTree.
		 */
		public SubMap()
		{
			low = null;
		...
		/**
		 * Devuelve si la clave especificada es válida para este SubMap.
		 */
		...
		/**
		 * Devuelve si este SubMap contiene la clave especificada.
		 */
		public boolean containsKey(Object key)
		{
		...
		/**
		 * Asocia el valor especificado con la clave especificada en este SubMap.
		 */
		public V put(K key, V value)
		{
			if(checkKey(key))
		...
		/**
		 * Devuelve el comparador utilizado para comparar claves.
		 */
		...
		/**
		 * Devuelve la primera clave en este SubMap.
		 */
		public K firstKey()
		{
		...
		/**
		 * Devuelve la última clave en este SubMap.
		 */
		public K lastKey()
		{
			K key = null;
		...
		/**
		 *Devuelve una vista de conjunto de las entradas asignadas en este submapa.
		 */
		public Set<Entry<K,V>> entrySet()
		{
			return esInstance;
		...
		/**
		 * Devuelve un mapa que representa un sub-rango de las claves almacenadas en este SubMap.
		 */
		public SortedMap<K, V> subMap(K arg0, K arg1)
		{
		...
		/**
		 * Un conjunto de entradas de mapa respaldadas por un SubMap.
		 */
////////////////////////////////////////////////////////////////////////////////////
		private class EntrySet extends AbstractSet<Entry<K,V>>
		{			
			/**
			 *Elimina todas las entradas de este conjunto.
			 */
			public void clear()
			{
			...
			/**
			 * Devuelve si este conjunto contiene la entrada especificada.
			 */
			...
			/**
			 *Devuelve un iterador que itera sobre los elementos en este conjunto.
			 */
			...
			/**
			 * Elimina la entrada especificada de este conjunto.
			 */
			...
			/**
			 * Devuelve el número de elementos en este conjunto.
			 */
			public int size()
			{
				if(low == null && high == null)
			...
			/**
			 *Iteriza a través de todas las entradas en el conjunto.
			 */
////////////////////////////////////////////////////////////////////////////////////
			private class EntrySetIterator implements Iterator<Entry<K,V>>
			{
				...
				/**
				 *Devuelve si quedan entradas en la iteración..
				 */
				...
				/**
				 * Devuelve la siguiente entrada en la iteración.
				 */
				...
				/**
				 * Elimina el elemento recuperado más recientemente de la colección.
				 */
				public void remove()
				{
					// Make sure tree has not been modified.
	...
	/**
	* Una entrada en un BPTree enlazada a una clave y respaldada por el árbol.
	 */
////////////////////////////////////////////////////////////////////////////////////
	private class BPTEntry implements Entry<K,V>
	{
		...
		/**
		 * Crea un nuevo BPTEntry enlazado a la clave especificada y respaldado por el árbol especificado.
		 */
		...
		/**
		 * Devuelve la clave a la que está vinculada esta entrada.
		 */
		public K getKey()
		{
			return key;
		...
		/**
		 *Devuelve el valor asociado a esta entrada.
		 */
		public V getValue()
		{
			return tree.get(key);
		...
		/**
		 * Establece el valor asociado a esta entrada. El BPTree se cambiará para reflejar el nuevo valor.
		 */
