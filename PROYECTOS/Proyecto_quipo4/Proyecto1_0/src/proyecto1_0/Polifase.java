...
public class Polifase {
    ...
    int iteraciones=0;
    void polifaseMetodo(String name) throws IOException{
        String nuevo=name;
        name=name+".txt";
        ...
        try{
            File archivo=new File(".\\src\\Archivos Polifase\\"+name);
            ...
            if(!archivo.exists()){
                ...
                if(Character.toUpperCase(q)=='S'){
                    ...
                    if(Character.toUpperCase(q)=='S'){
                        ...
                        File ruta=new File(".\\src\\Archivos Polifase\\"+nuevo);
                        ruta.mkdir();
                        ...
                        do{
                        System.out.println("Ingrese la cantidad de claves con las que desea iniciar");
                        System.out.print("El rango es de 1 a 100: ");
                        j=sc.nextInt();
                        }while(j>tam && j<0);
        ...
        bloque2 = new LinkedList[tam/2];
            for(int i=0;i<tam/2;i++){
                ...
                for(int a=0;a<j;a++)
                    ...
                    ordenamiento.sort(bloque1[i], 0, (bloque1[i].size()-1));
                for(int a=0;a<j;a++)
                        if(cadenas.size()!=0)bloque2[i].add(cadenas.poll());
                    ordenamiento.sort(bloque2[i], 0, (bloque2[i].size()-1));
                }
            try{
                ...
                ordenamiento.sort(salida[i], 0, (salida[i].size()-1));
                }
